...
# Security
This tulip instance is modified to use nginx as a reverse proxy to provide basic auth capabilities to the tulip web interface.
You just neet to place your .htpasswd in the home directory (the same directory where the nginx.conf is).
To generate the .htpasswd you can use the command 
```
